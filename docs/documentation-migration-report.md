...
- Some earlier material contains schedules, performance targets, child-use language, and compatibility implications that need revalidation.
...
- Sensor suite, motor interface, compute, navigation, inference, and communications remain subject to evidence and safety review.
...
`PRODUCT.md`; `docs/vision/PROJECT_AIM.md`; `docs/status/PROJECT_SCORECARD.md`; legacy `docs/ARCHITECTURE.md`; `docs/specifications/HARDWARE_STATUS_UPDATE.md`; `SENSECAP_WATCHER_HARDWARE_SELECTION.md`; `system_spec.md`; `AUTONOMY_LEVELS.md`; `docs/testing/test_plan.md`; and the proposed ADRs.
...
3. Validate the simulation and ROS 2 baseline using proofs of concept.
4. Add legacy/front-matter banners consistently after owner review.
5. Maintain labels, branch protection, Project views, Discussions, and required reviewers.
